...
[System.Serializable]
public class ModranUiElements
{
    [Header("Scrollers")]
    public GameObject aLLScrollers;
    public GameObject categoryScroller, dressScroller, BagScroller, hairScrolleer, BangelsScroller, shoeScroller, earRingScroller, EyeShadesScroller, lipstickScroller,
                      necklaceScroller, EyeBrowScroller, BgScroller;
    [Header("Images")]
    public Image dressImage;
    public Image BagImage, hairImage, BangelsImage, shoesImage, earRingsImage, EyeShadesImage, lipstickImage, neckLaceImage, EyeBrowImage, BgImage;
    public Image videoSlotItem, coinslotItem;
}
[System.Serializable]
public class ModranOpponent
{
    [Header("Images")]
...
[System.Serializable]
public enum ModranSelectedItem
{
     Dress, Hair, EyeShades, EyeBrow, Lipstick, EarRings, NeckLace, Bangels, Bag, Shoes, BackGround
}
public class ModranMode : MonoBehaviour
{
    public ModranSelectedItem selectedItem;
    public ModranUiElements uIElements;
    public ModranOpponent oppElements;
    [Header("Panels")]
    ...
    private int dressValue, hairValue, bangleValue, earringValue, eyeshadesValue, lipstickValue, necklaceValue, EyeBrowValue, shoeValue, bgValue, BagValue;
    private int oppodressValue, oppohairValue, oppobangleValue, oppoearringValue, oppoeyeshadesValue, oppolipstickValue, opponecklaceValue,
    ...
    private void Start()
    {
        ...
        selectedItem = ModranSelectedItem.Dress;
    ...
    private void SetInitialValues()
    {
        ...
        SetupItemData(SaveData.Instance.modranProps.dressLocked, dressList);
        ...
        SetupItemData(SaveData.Instance.modranProps.bagLocked, BagList);
        ...
        SetupItemData(SaveData.Instance.modranProps.hairLocked, hairList);
        ...
        SetupItemData(SaveData.Instance.modranProps.bangelsLocked, BangelsList);
        ...
        SetupItemData(SaveData.Instance.modranProps.shoesLocked, ShoesList);
        ...
        SetupItemData(SaveData.Instance.modranProps.earRingLocked, earRingsList);
        ...
        SetupItemData(SaveData.Instance.modranProps.eyeShadesLocked, EyeShadesList);
        ...
        SetupItemData(SaveData.Instance.modranProps.lipsTickLocked, lipstickList);
        ...
        SetupItemData(SaveData.Instance.modranProps.necklaceLocked, neckLaceList);
        ...
        SetupItemData(SaveData.Instance.modranProps.noseRingLocked, EyeBrowList);
        ...
        SetupItemData(SaveData.Instance.modranProps.BGLocked, backgroundList);
    ...
    public void SelectedCatagory(int index)
    {
        ...
        if (index == (int)ModranSelectedItem.Dress)
        {
            selectedItem = ModranSelectedItem.Dress;
            uIElements.dressScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.Hair)
        {
            selectedItem = ModranSelectedItem.Hair;
            uIElements.hairScrolleer.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.Bangels)
        {
            selectedItem = ModranSelectedItem.Bangels;
            uIElements.BangelsScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.EarRings)
        {
            selectedItem = ModranSelectedItem.EarRings;
            uIElements.earRingScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.Bag)
        {
            selectedItem = ModranSelectedItem.Bag;
            uIElements.BagScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);

        }
        else if (index == (int)ModranSelectedItem.EyeShades)
        {
            selectedItem = ModranSelectedItem.EyeShades;
            uIElements.EyeShadesScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.Lipstick)
        {
            selectedItem = ModranSelectedItem.Lipstick;
            uIElements.lipstickScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)ModranSelectedItem.NeckLace)
        {
            selectedItem = ModranSelectedItem.NeckLace;
            uIElements.necklaceScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)ModranSelectedItem.EyeBrow)
        {
            selectedItem = ModranSelectedItem.EyeBrow;
            uIElements.EyeBrowScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)ModranSelectedItem.Shoes)
        {
            selectedItem = ModranSelectedItem.Shoes;
            uIElements.shoeScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)ModranSelectedItem.BackGround)
        {
            selectedItem = ModranSelectedItem.BackGround;
    ...
    {
        if (selectedItem == ModranSelectedItem.Dress)
        {
            SetItemsInfo(dressList, DressScore);
        }
        else if (selectedItem == ModranSelectedItem.Bag)
        {
            SetItemsInfo(BagList, BagScore);
        }
        else if (selectedItem == ModranSelectedItem.Hair)
        {
            SetItemsInfo(hairList, HairScore);
        }
        else if (selectedItem == ModranSelectedItem.Bangels)
        {
            SetItemsInfo(BangelsList, BangelsScore);
        }
        else if (selectedItem == ModranSelectedItem.Shoes)
        {
            SetItemsInfo(ShoesList, ShoesScore);
        }
        else if (selectedItem == ModranSelectedItem.EarRings)
        {
            SetItemsInfo(earRingsList, EarRingsScore);
        }
        else if (selectedItem == ModranSelectedItem.EyeShades)
        {
            SetItemsInfo(EyeShadesList, EyeShadesScore);
        }     
        else if (selectedItem == ModranSelectedItem.Lipstick)
        {
            SetItemsInfo(lipstickList, LipstickScore);
        }
        else if (selectedItem == ModranSelectedItem.NeckLace)
        {
            SetItemsInfo(neckLaceList, NeckLaceScore);
        }
        else if (selectedItem == ModranSelectedItem.BackGround)
        {
            SetItemsInfo(backgroundList, BGScore);
        }
        else if (selectedItem == ModranSelectedItem.EyeBrow)
        {
    ...
    IEnumerator SoureParticalPlay(List<ItemInfo> itemInfo)
    {
        ...
        yield return new WaitForSeconds(0.5f);
        totalScore.text = (dressValue + hairValue + bangleValue + earringValue + eyeshadesValue + lipstickValue + necklaceValue +
    ...
    public void UnlockSingleItem()
    {
        if (selectedItem == ModranSelectedItem.Dress)
        {
            SaveData.Instance.modranProps.dressLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.Bag)
        {
            SaveData.Instance.modranProps.bagLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.Hair)
        {
            SaveData.Instance.modranProps.hairLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.Bangels)
        {
            SaveData.Instance.modranProps.bangelsLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.Shoes)
        {
            SaveData.Instance.modranProps.shoesLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.EarRings)
        {
            SaveData.Instance.modranProps.earRingLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.EyeShades)
        {
            SaveData.Instance.modranProps.eyeShadesLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.Lipstick)
        {
            SaveData.Instance.modranProps.lipsTickLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.NeckLace)
        {
            SaveData.Instance.modranProps.necklaceLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.EyeBrow)
        {
            SaveData.Instance.modranProps.noseRingLocked[selectedIndex] = false;
        }
        else if (selectedItem == ModranSelectedItem.BackGround)
        {
            SaveData.Instance.modranProps.BGLocked[selectedIndex] = false;
        }
        Rai_SaveLoad.SaveProgress();
    }
    #endregion
    ...
    IEnumerator StartComparing()
    {
        ...
        yield return new WaitForSeconds(0.5f);
        playerRank = eyeshadesValue + lipstickValue + EyeBrowValue;
        playerTotal += playerRank;
        oppElements.playerTotal.text = playerTotal.ToString();
        yield return new WaitForSeconds(0.5f);
        ...
        yield return new WaitForSeconds(0.5f);
        oppoRank = oppoeyeshadesValue + oppolipstickValue + oppoEyeBrowValue;
        opTotal += oppoRank;
        oppElements.oppoTotal.text = opTotal.ToString();
        yield return new WaitForSeconds(0.5f);
